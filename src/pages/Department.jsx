...
import { MCGrid } from '../components/MCImageCard'
    ...
    <div className="container-app space-y-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-[11px] font-bold text-smoke">{dep?.top_name ? dep.top_name + ' • ' : ''}{products ? products.length + ' خدمة' : ''}</p>
        </div>
      </div>
