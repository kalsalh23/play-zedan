...
const REPO_JUNK = ['brand-out.txt', 'check-missing.mjs', 'grab-branded.mjs', 'grab-images.mjs', 'harvest-departments.mjs', 'harvest-out.txt', 'hero3.mjs', 'hero3.txt', 'missing-deps.txt', 'sample-cat-.png', 'sample-cat-slider.png', 'sample-dep-.png']
